    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "המשכן | המרכז לשיקום נפגעי טראומה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'e8b83dd4-1b9e-4d23-a719-58d85f2bf1cf',
                    name: data.name || '',
                    email: data.email || '',
